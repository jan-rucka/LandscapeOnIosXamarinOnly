    ...
    public static class PropertySupport
    {
        ...
        internal static string ExtractPropertyNameFromLambda(LambdaExpression expression)
        {
            ...
            if (memberExpression == null)
                throw new ArgumentException("NotMemberAccessExpression_Exception", nameof(expression));

            var property = memberExpression.Member as PropertyInfo;
            if (property == null)
                throw new ArgumentException("ExpressionNotProperty_Exception", nameof(expression));
